  ...
  if (!videos || videos.length === 0) {
    return (
      <div className="text-[var(--text-muted)] italic text-sm">
        No video recommendations available yet. Submit more code to get personalised suggestions.
      </div>
    );
  }
            ...
            <div className="relative aspect-video bg-gradient-to-br from-gray-900 to-gray-800 border-b border-[var(--border)] flex items-center justify-center">
              {!isSearchLink ? (
                ...
                <div className="flex flex-col items-center justify-center gap-3 p-4 text-center">
                  ...
                  <span className="text-xs text-gray-400">Click to search on YouTube</span>
                </div>
              )}
